// L2 module tests โ€?client module redirection (design.md ยง4.6, ยง5.3, ยง5.4).
...
// TC-BND-CLI-01: no document โ?module aliases still register, no throw.
...
// TC-BND-SEC-01: unknown / escape-path module specifier โ?ModuleNotFoundError.
...
test('TC-PKG-04 stable @dsh-plugin/dsh-loader/* names map to real dsh packages', () => {
  ...
  // installClient with no opts.packageAliases โ€?uses adapter defaults
  // which include @dsh-plugin/dsh-loader/ui-primitives โ?@deepseek-ai/dsh-client-ui-primitives
  installClient({ window });
  requires.length = 0;
