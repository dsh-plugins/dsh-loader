// L2 module tests â€?client module redirection (design.md Â§4.6, Â§5.3, Â§5.4).
...
// TC-BND-CLI-01: no document â†?module aliases still register, no throw.
...
// TC-BND-SEC-01: unknown / escape-path module specifier â†?ModuleNotFoundError.
...
test('TC-PKG-04 stable @dsh-plugin/dsh-loader/* names map to real dsh packages', () => {
  ...
  // installClient with no opts.packageAliases â€?uses adapter defaults
  // which include @dsh-plugin/dsh-loader/ui-primitives â†?@deepseek-ai/dsh-client-ui-primitives
  installClient({ window });
  requires.length = 0;
...
// â”€â”€ ensureDshModulesGlobal: legacy __DSH_MODULES__ shim (dsh 0.1.0-rc.8+) â”€â”€
