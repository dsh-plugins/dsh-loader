// L2 module tests â€?settings whitelist security warning (design.md Â§4.2b TC-SEC-03).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { apply } from '../../dist/index.js';
import { makeMockCtx, makeMockWebServer } from '../helpers/mock.mjs';

// TC-SEC-03: exposeAllNamespaces=true â†?startup logs explicit security warning.
